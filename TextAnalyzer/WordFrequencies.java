...
public class WordFrequencies {
    ...
    static WordData[] words; // Created an array to hold the words from the file.


    static int wordCount; // Created an int for the number of words currently stored in
                          // the array.
    ...
    public static void main(String[] args) {
        ...
        if (out.checkError()) {
            TextIO.putln("An error occurred while scanning to the output file.");
            TextIO.putln("The output might be missing, incomplete, or corrupted.");
        } else {
            TextIO.putln("Scanning Complete. Added text file to current folder.");
        }
